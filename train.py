    ...
    for epoch in range(start_epoch+1, opt.num_epochs+1):
        ...
        for batch_id, data in enumerate(train_syn_loader):
            ...
            if not opt.ema:
                ...
                hazy_img_syn_1, hazy_img_syn_2, clear_img_syn, id, extension = data
                ...
                if epoch == start_epoch+1:
                    ...
                    syn_contrast_loss = criterion[1](a1_out, clear_img_syn, pre_dehaze_1, pre_dehaze_2)
                    ...
                    for i in range(opt.train_batch_size):
                        ...
                        if (ssim_dehaze_gt_1 < ssim_neg_gt_1 and psnr_dehaze_gt_1 < psnr_neg_gt_1) and (
                                ssim_dehaze_gt_2 < ssim_neg_gt_2 and psnr_dehaze_gt_2 < psnr_neg_gt_2):
                            syn_contrast_loss_list.append(
                                criterion[1](a1_out[i, :, :, :].unsqueeze(0), clear_img_syn[i, :, :, :].unsqueeze(0),
                                             pre_dehaze_1, pre_dehaze_2))
                ...
                # syn total loss
                syn_loss = syn_consist_loss + syn_l1_loss + 0.001 * syn_contrast_loss
